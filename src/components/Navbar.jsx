  ...
  return (
    <div className=" flex justify-beteen items-center h-24 max-w-[1500px] px-4 text-white">
      ...
      <ul className="hidden sm:flex text-xl ">
        <li className="p-5 mt-1 hover:text-[#00df9a] cursor-pointer ">Home</li>
        <li className="p-5 mt-1 hover:text-[#00df9a] cursor-pointer">Company</li>
        <li className="p-5 mt-1 hover:text-[#00df9a] cursor-pointer">Resources</li>
        <li className="p-5 mt-1 hover:text-[#00df9a] cursor-pointer">About</li>
        <li className="p-5 mt-1 hover:text-[#00df9a] cursor-pointer">Contact</li>
      </ul>
      ...
      <div className={nav ? "fixed left-0 top-0 w-[60%] border-r h-full border-r-gray-900 bg-[#000300] ease-in-out duration-300": 'fixed left-[-100%]'}>
        <h1 className="w-full text-2xl font-bold text-[#00df9a] m-4">THRIVE</h1>
