...
<div className='flex flex-col justify-center'>
  ...
  <button className="text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto sm:mx-0 py-3 bg-black  hover:bg-[#00df9a] hover:text-black active:bg-black active:text-[#00df9a]">Get Started</button>
</div>
</div>
    </div>
  )
