  ...
  return (
    <div className="text-white">
      <div className="max-w-[850px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center">
        ...
        <button className="bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black  hover:bg-black hover:text-[#00df9a] active:bg-[#00df9a] active:text-black">Get Started</button>
      </div>
    </div>
  );
};
